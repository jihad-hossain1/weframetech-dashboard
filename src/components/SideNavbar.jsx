...
import { BiSolidGridAlt, BiSolidMoviePlay } from "react-icons/bi";
import {
  RiCalendarFill,
  RiArrowRightSLine,
  RiArrowDownSLine,
    ...
    <>
      ...
      <div className=' hidden md:block flex-none max-w-[350px] bg-[#15132B] px-12 '>
        ...
        <div className='text-[#464366] mt-14'>
          <h4 className='uppercase text-slate-100 mb-8 font-semibold'>
            Main Menu
          </h4>
              ...
              <div className='cursor-pointer'>
                ...
                >
                  ...
                  <div className='flex space-x-3 items-center'>
                    ...
                    <div>
                      {isEmailActive ? (
                        <RiArrowDownSLine className='text-2xl text-[#7879F1]'></RiArrowDownSLine>
                      ) : (
                        <RiArrowRightSLine className='text-2xl text-[#7879F1]'></RiArrowRightSLine>
                      )}
                    </div>
                  </div>
                </div>
      ...
      {/* for mobile user  */}
      <div className="">
      {toggle ? <RxCross1  onClick={()=>setToggle(!toggle)} className='block md:hidden text-3xl text-[#7879F1] cursor-pointer'></RxCross1> : <HiBars3  onClick={()=>setToggle(!toggle)} className='block md:hidden text-3xl text-[#7879F1] cursor-pointer'></HiBars3>}
      </div>
      {toggle && <>
        <ul className=' flex flex-col space-y-8 mt-8 text-[#464366]'>
            <li>
              <NavLink
